...
Candidate `949eefe` · win32 / node 24.16.0 / postgres 16 / BullMQ mocked

| Rows | Duration | Rows/s | Chunk p50 | Chunk p95 | Chunk p99 | Leads | Accounts | Contacts | Lost | Duplicate | Heap Δ |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **120** | 16.80s | 7.14 | 4458ms | 4991ms | 4991ms | 120 | 20 | 120 | 0 | 0 | 1.18 MB |
| **500** | 57.95s | 8.63 | 4404ms | 8034ms | 8034ms | 500 | 20 | 500 | 0 | 0 | 2.47 MB |
| **1000** | 90.47s | 11.05 | 3339ms | 8318ms | 8318ms | 1000 | 20 | 1000 | 0 | 0 | -0.69 MB |

---

## 3. `IMPORT_SYSTEM_QUEUE_BENCHMARK`

Candidate `949eefe` · win32 / node 24.16.0 / postgres 16 / real Redis / real BullMQ
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| **120** | 3 | 3.03s | 39.58 | 6ms | 14ms | 14ms | 2830ms | 2850ms | 2850ms | 0 | 0 | 0 | 0 |
| **500** | 10 | 11.85s | 42.19 | 3699ms | 9394ms | 9394ms | 2979ms | 3748ms | 3748ms | 0 | 0 | 0 | 0 |
| **1000** | 20 | 22.56s | 44.32 | 9904ms | 19746ms | 19746ms | 3129ms | 4010ms | 4076ms | 0 | 0 | 0 | 0 |

### What the queue measurement shows that the handler benchmark cannot

Queue wait p95 rises from 14ms at the
smallest scale to 19746ms at the
