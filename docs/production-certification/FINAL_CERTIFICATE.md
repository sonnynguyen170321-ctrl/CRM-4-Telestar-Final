...
note: |
  ...
  certification.
generatedAt: 2026-08-25T11:25:23.695Z
...
**Verdict**: **NO-GO — BLOCKERS REMAIN**
**Generated**: 2026-08-25T11:25:23.693Z
...
|---|---|---|
| Vitest files passed | 197 / 197 | `EV-VITEST` |
| Vitest tests passed | 2847 | `EV-VITEST` |
...
**Check `A`** — 20 finding(s)
  - docs/production-certification/EVIDENCE.md declares unknown SHA 016e020
  - docs/production-certification/EVIDENCE.md still references non-candidate SHA 016e020 (candidate is 949eefe)
  - docs/production-certification/EVIDENCE.md still references non-candidate SHA c7bf639 (candidate is 949eefe)
  - docs/production-certification/FINAL_CERTIFICATE.md still references non-candidate SHA 5985ec4 (candidate is 949eefe)
  - docs/production-certification/FINAL_CERTIFICATE.md still references non-candidate SHA c7bf639 (candidate is 949eefe)
  - docs/production-certification/evidence/EV-BRANCH-PROTECTION.json declares unknown SHA 016e020
  - …and 14 more

**Check `L`** — 2 finding(s)
  - run 1 gate "19-docker-build" is FAIL
  - run 1 gate "20-image-inspection" is BLOCKED_EXTERNAL

**Check `S`** — 1 finding(s)
  - deployed health SHA c7bf639 differs from candidate 949eefe

**Check `TIME_IMPOSSIBILITY`** — 15 finding(s)
  - EV-BRANCH-PROTECTION: execution started at 2026-08-25T09:46:01.958Z which predates candidate freeze 2026-08-25T10:45:00.000Z
  - EV-CI-RUN: execution started at 2026-08-24T09:28:55Z which predates candidate freeze 2026-08-25T10:45:00.000Z
  - EV-DEPLOYED-STATE: execution started at 2026-08-24T09:42:16.857Z which predates candidate freeze 2026-08-25T10:45:00.000Z
  - EV-DR-BACKUP: execution started at 2026-08-24T09:30:00.000Z which predates candidate freeze 2026-08-25T10:45:00.000Z
  - EV-DR-NEGATIVE-CONTROL: execution started at 2026-08-24T09:30:00.000Z which predates candidate freeze 2026-08-25T10:45:00.000Z
  - EV-DR-RESTORE: execution started at 2026-08-24T09:30:00.000Z which predates candidate freeze 2026-08-25T10:45:00.000Z
  - …and 9 more

**Check `SOURCE_MISMATCH`** — 2 finding(s)
  - EV-RUN-2: gate 01 measured head 482fef5, which is not candidate 949eefe
  - EV-RUN-3: gate 01 measured head e883ba7, which is not candidate 949eefe

**Check `CI_SHA_MISMATCH`** — 1 finding(s)
  - CI run 32711776013 head SHA c7bf639 differs from candidate 949eefe

**Check `RUN_IDENTITY`** — 2 finding(s)
  - EV-RUN-2 records no executionId
  - EV-RUN-3 records no executionId

**Check `REQ`** — 10 finding(s)
  - DR-001 is not VERIFIED: evidence of kind "dr-backup" exists but none is for candidate 949eefe
  - DR-002 is not VERIFIED: evidence of kind "dr-restore" exists but none is for candidate 949eefe
  - DR-003 is not VERIFIED: evidence of kind "dr-rollback" exists but none is for candidate 949eefe
  - DR-006 is not VERIFIED: evidence of kind "dr-restore" exists but none is for candidate 949eefe
  - DR-007 is not VERIFIED: evidence of kind "dr-rpo" exists but none is for candidate 949eefe
  - REL-001 is not VERIFIED: evidence of kind "release-identity" exists but none is for candidate 949eefe
  - …and 4 more
