...
note: |
  ...
  certification.
generatedAt: 2026-08-23T19:50:02.356Z
...
**Verdict**: **NO-GO — BLOCKERS REMAIN**
**Generated**: 2026-08-23T19:50:02.355Z
...
**Check `A`** — 5 finding(s)
  ...
  - docs/production-certification/FINAL_CERTIFICATE.md still references non-candidate SHA 12ea8ae (candidate is d5d7cf8)
  ...
  - docs/production-certification/evidence/EV-RELEASE-IDENTITY.json carries evidence for non-candidate SHA 9fa36d3 (candidate is d5d7cf8)

**Check `S`** — 1 finding(s)
  - deployed health SHA 9fa36d3 differs from candidate d5d7cf8

**Check `REQ`** — 2 finding(s)
  - DR-003 is not VERIFIED: evidence of kind "dr-rollback" exists but none is for candidate d5d7cf8
  - REL-001 is not VERIFIED: evidence of kind "release-identity" exists but none is for candidate d5d7cf8
