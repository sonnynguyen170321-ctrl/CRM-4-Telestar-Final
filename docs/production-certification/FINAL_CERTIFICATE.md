...
note: |
  ...
  certification.
generatedAt: 2026-08-25T05:46:57.961Z
...
**Verdict**: **NO-GO — BLOCKERS REMAIN**
**Generated**: 2026-08-25T05:46:57.958Z
...
**Check `01`** — 1 finding(s)
  - working tree has 3 uncommitted non-metadata path(s): package.json, scripts/cutover/safe-cutover-tool.ts, tests/safe-cutover-tool.test.ts

**Check `N`** — 8 finding(s)
  - commit 2933e53 after candidate freeze touches non-certification file(s): scripts/cutover/approved-roster.json, scripts/restore-internal-users.ts
  - commit b228e6b after candidate freeze touches non-certification file(s): scripts/cutover/approved-roster.json, scripts/restore-internal-users.ts
  - commit 3a3b51d after candidate freeze touches non-certification file(s): scripts/cutover/approved-roster.json, scripts/restore-internal-users.ts
  - commit fe0b2d7 after candidate freeze touches non-certification file(s): scripts/cutover/approved-roster.json, scripts/restore-internal-users.ts
  - commit 31deb37 after candidate freeze touches non-certification file(s): scripts/cutover/approved-roster.json, scripts/restore-internal-users.ts
  - commit 25c3699 after candidate freeze touches non-certification file(s): scripts/restore-internal-users.ts
  - …and 2 more
