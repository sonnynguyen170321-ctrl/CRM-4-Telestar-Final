...
note: |
  ...
  certification.
generatedAt: 2026-08-25T10:21:07.444Z
...
**Verdict**: **NO-GO — BLOCKERS REMAIN**
**Generated**: 2026-08-25T10:21:07.442Z
...
**Check `01`** — 1 finding(s)
  - working tree has 2 uncommitted non-metadata path(s): scripts/cutover/safe-cutover-tool.ts, tests/safe-cutover-tool.test.ts
