...
**Ran**: 2026-08-27T21:51:00.570Z → 2026-08-27T22:09:20.669Z (18.3 min)
...
| `19-docker-build` | **PASS** | 0 | 504.7s | — |
| `20-image-inspection` | **PASS** | 0 | 0.3s | — |
| `21-compose-validation` | **PASS** | 0 | 1.1s | — |
| `23-validator-selftest` | **PASS** | 0 | 8.3s | — |
