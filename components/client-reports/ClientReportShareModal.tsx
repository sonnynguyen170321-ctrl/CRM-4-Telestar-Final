      ...
      <div className="bg-card border border-border rounded-xl shadow-2xl w-full max-w-xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-muted/30">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-semibold text-foreground">Share Client Report</h3>
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-medium text-foreground block mb-1">Expiration</label>
                <select
                  value={expiryDays}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-background border border-border rounded-lg pl-8 pr-3 py-2 text-xs text-foreground placeholder:text-muted-foreground focus:ring-1 focus:ring-brand-red focus:outline-none"
                  />
            ...
            {loading ? (
              ...
              <div className="space-y-2">
                {links.map((link) => (
                  <div
                    key={link.id}
                    className="p-3 bg-muted/40 border border-border/60 rounded-lg flex items-center justify-between gap-3 text-xs"
                  >
